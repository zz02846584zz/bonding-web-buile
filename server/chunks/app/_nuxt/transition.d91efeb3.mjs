...
import { R, f, O, t, u, o, c, l as l$1, P, p, w as w$1 } from './open-closed.5d362c74.mjs';
...
function K(e) {
  ...
  function v(r) {
    ...
    return n ? n.state !== "visible" && (n.state = "visible") : t2.value.push({ id: r, state: "visible" }), () => s2(r, O.Unmount);
  }
...
let _ = R.RenderStrategy, oe = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t$1, attrs: a, slots: s2, expose: v }) {
  ...
  let r = ref(null), n = ref("visible"), l2 = computed(() => e.unmount ? O.Unmount : O.Hidden);
  v({ el: r, $el: r });
  ...
  let k = d(e.enter), $ = d(e.enterFrom), q = d(e.enterTo), O$1 = d(e.entered), z = d(e.leave), G = d(e.leaveFrom), J = d(e.leaveTo);
  onMounted(() => {
    watchEffect(() => {
      if (n.value === "visible") {
        let o$1 = o(r);
  ...
  function Q(o$1) {
    ...
    !u2 || !(u2 instanceof HTMLElement) || c2 || (S.value = true, i.value && t$1("beforeEnter"), i.value || t$1("beforeLeave"), o$1(i.value ? L(u2, k, $, q, O$1, (C) => {
...
export { fe as f, oe as o, s };
//# sourceMappingURL=transition.d91efeb3.mjs.map

...
import { P as P$1 } from './use-outside-click.01e1b2e0.mjs';
...
let f = defineComponent({ name: "Hidden", props: { as: { type: [Object, String], default: "div" }, features: { type: Number, default: 1 } }, setup(r, { slots: t, attrs: d }) {
  return () => {
    ...
    return P$1({ ourProps: n, theirProps: o, slot: {}, attrs: d, slots: t, name: "Hidden" });
  };
} });

export { a, f };
//# sourceMappingURL=hidden.90d807c6.mjs.map

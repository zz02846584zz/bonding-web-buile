...
import { defineComponent, reactive, withCtx, unref, createVNode, useSSRContext, computed } from 'vue';
...
const _sfc_main$1 = {
  ...
  dark:border-gray-50/[0.2] dark:focus:bg-gray-800`
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="flex items-center"><div class="relative model flex-1"><input${ssrRenderAttr("id", __props.id)} class="${ssrRenderClass([unref(defaultStyle), unref(inputSize)])}"${ssrRenderAttr("type", unref(showPw) ? "password" : "text")}${ssrRenderAttr("placeholder", __props.placeholder)}${ssrRenderAttr("value", __props.modelValue || __props.value)}${ssrIncludeBooleanAttr(__props.disabled) ? " disabled" : ""} autocomplete="on"><div class="absolute flex transform -translate-y-1/2 icon top-1/2 right-2 cursor-pointer">`);
...
//# sourceMappingURL=reset-password.05b910dc.mjs.map

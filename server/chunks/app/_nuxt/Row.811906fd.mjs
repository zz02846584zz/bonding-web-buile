...
import { f as fe, o as oe } from './transition.bb7f9059.mjs';
                ...
                default: withCtx((_2, _push4, _parent3, _scopeId2) => {
                  if (_push4) {
                    ...
                    if (!unref(dialogLoading)) {
                      ...
                      _push4(`<div class="text-sm opacity-60"${_scopeId2}>${ssrInterpolate(unref(dialogInfo).publishDate)}</div>`);
                      if (unref(dialogInfo).content) {
                        _push4(`<div class="py-4"${_scopeId2}>${unref(dialogInfo).content}</div>`);
                      } else {
                        _push4(`<!---->`);
                      }
                      _push4(`</div>`);
                    ...
                    return [
                      createVNode("div", { class: "fixed top-0 left-0 w-full h-full z-20" }, [
                        ...
                        !unref(dialogLoading) ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "text-sm opacity-60" }, toDisplayString(unref(dialogInfo).publishDate), 1),
...
//# sourceMappingURL=Row.811906fd.mjs.map

import { c as useContent, y as useRequestEvent, z as useContentHead, A as __nuxt_component_0$1, B as _sfc_main$q, C as _sfc_main$p, D as _sfc_main$o } from '../server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DocumentDrivenEmpty = _sfc_main$p;
      const _component_DocumentDrivenNotFound = _sfc_main$o;
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+content@2.2.0/node_modules/@nuxt/content/dist/runtime/pages/document-driven.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=document-driven.eb7ed227.mjs.map

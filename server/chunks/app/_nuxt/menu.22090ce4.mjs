import { y, h, F, o, c, u, l, P as P$1, t, p as p$1, R, _ as __nuxt_component_0, a as o$1, v as v$1, M, D as D$1, m as m$1, O } from './use-outside-click.01e1b2e0.mjs';
...
import { b, x, a } from './use-resolve-button-type.7f42ff8d.mjs';
...
let ve = defineComponent({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(o$12, { slots: S, attrs: l$1 }) {
  ...
  return y([e, p2], (r, a2) => {
    ...
    return P$1({ ourProps: {}, theirProps: o$12, slot: r, slots: S, attrs: l$1, name: "Menu" });
  };
  ...
  return () => {
    ...
    return P$1({ ourProps: t2, theirProps: o$2, slot: i, attrs: S, slots: l2, name: "MenuButton" });
  };
  ...
  return () => {
    ...
    return P$1({ ourProps: r, theirProps: o$2, slot: t2, attrs: S, slots: l$1, features: R.RenderStrategy | R.Static, visible: i.value, name: "MenuItems" });
  };
  ...
  return () => {
    ...
    return P$1({ ourProps: { id: p2, ref: u2, role: "menuitem", tabIndex: a2 === true ? void 0 : -1, "aria-disabled": a2 === true ? true : void 0, onClick: I, onFocus: i, onPointermove: t$1, onMousemove: t$1, onPointerleave: r, onMouseleave: r }, theirProps: o$12, slot: n, attrs: l2, slots: S, name: "MenuItem" });
  };
} });
...
//# sourceMappingURL=menu.22090ce4.mjs.map

import { hasProtocol, parseURL, parseQuery, withBase, withQuery } from 'ufo';
...
const _globalThis$3 = typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : typeof global !== "undefined" ? global : {};
const globalKey$1 = "__unctx__";
const defaultNamespace = _globalThis$3[globalKey$1] || (_globalThis$3[globalKey$1] = createNamespace());
const getContext = (key) => defaultNamespace.get(key);
const asyncHandlersKey = "__unctx_async_handlers__";
const asyncHandlers = _globalThis$3[asyncHandlersKey] || (_globalThis$3[asyncHandlersKey] = /* @__PURE__ */ new Set());
...
function useAsyncData(key, handler, options = {}) {
  ...
  asyncData.refresh = (opts = {}) => {
    ...
    if (opts._initial && options.initialCache && nuxt.payload.data[key] !== void 0) {
...
const getGlobalThis$1 = () => {
  return _globalThis$2 || (_globalThis$2 = typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : typeof commonjsGlobal !== "undefined" ? commonjsGlobal : {});
};
...
const components = {};
function components_67f29fa2(nuxtApp) {
...
const vueuseHead_75465c68 = defineNuxtPlugin((nuxtApp) => {
...
const metaConfig = { "globalMeta": { "meta": [{ "charset": "utf-8" }, { "name": "viewport", "content": "width=device-width, initial-scale=1" }], "title": "A Better Nuxt 3 Starter", "link": [], "style": [], "script": [] }, "mixinKey": "created" };
const metaMixin = {
  [metaConfig.mixinKey]() {
    var _a;
    const instance = vue_cjs_prod.getCurrentInstance();
...
const plugin_4dd1e45c = defineNuxtPlugin((nuxtApp) => {
...
const router_200b4f7e = defineNuxtPlugin((nuxtApp) => {
  const routes = [];
  const hooks = {
    "navigate:before": [],
    "resolve:before": [],
...
const messages = { "en": localeEn_564a1578, "ja": localeJa_564a1606, "zh-CN": localeZhCN_cf43878a };
const isEmpty = (obj) => Object.keys(obj).length === 0;
const plugin_1079364c = defineNuxtPlugin(async (nuxt) => {
...
function useDark(options = {}) {
  ...
  const preferredDark = usePreferredDark({ window: window2 });
  const isDark2 = vue_cjs_prod.computed({
    get() {
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-27654d88><div class="fixed left-0 right-0 spotlight z-10" data-v-27654d88></div><div class="max-w-520px text-center z-20" data-v-27654d88><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-27654d88>${serverRenderer.exports.ssrInterpolate(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-27654d88>${serverRenderer.exports.ssrInterpolate(__props.description)}</p><div class="w-full flex items-center justify-center" data-v-27654d88>`);
...
const Error404 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-27654d88"]]);
const _sfc_main$4 = {
  __ssrInlineRender: true,
  props: {
    appName: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-6a3e10a6><div class="fixed -bottom-1/2 left-0 right-0 h-1/2 spotlight" data-v-6a3e10a6></div><div class="max-w-520px text-center" data-v-6a3e10a6><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-6a3e10a6>${serverRenderer.exports.ssrInterpolate(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-6a3e10a6>${serverRenderer.exports.ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
const Error500 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-6a3e10a6"]]);
const _sfc_main$2 = {
  __ssrInlineRender: true,
  props: {
    error: Object
...
const __unplugin_components_4 = { name: "simple-icons-nuxtdotjs", render: render$4 };
const _hoisted_1$3 = {
  width: "1.2em",
  height: "1.2em",
  preserveAspectRatio: "xMidYMid meet",
...
const __unplugin_components_3 = { name: "carbon-logo-github", render: render$3 };
const _hoisted_1$2 = {
  width: "1.2em",
  height: "1.2em",
  preserveAspectRatio: "xMidYMid meet",
...
const __unplugin_components_2 = { name: "carbon-moon", render: render$2 };
const _hoisted_1$1 = {
  width: "1.2em",
  height: "1.2em",
  preserveAspectRatio: "xMidYMid meet",
...
const __unplugin_components_1 = { name: "carbon-sun", render: render$1 };
const _hoisted_1 = {
  width: "1.2em",
  height: "1.2em",
  preserveAspectRatio: "xMidYMid meet",
...
const __unplugin_components_0 = { name: "carbon-language", render };
const useCounter = defineStore("counter", {
  state: () => ({
    n: 5,
    myRef: vue_cjs_prod.ref("hello")
  }),
  actions: {
    increment() {
      this.n++;
...
const _sfc_main = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useAsyncData("/api/hello", () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_carbon58language = __unplugin_components_0;
      const _component_carbon58sun = __unplugin_components_1;
      const _component_carbon58moon = __unplugin_components_2;
      const _component_carbon58logo_github = __unplugin_components_3;
      const _component_simple_icons58nuxtdotjs = __unplugin_components_4;
      _push(`<!--[--><div class="text-secondary-darker dark:text-white bg-cloud-surface dark:bg-sky-darkest"><div class="relative flex items-top justify-center min-h-screen sm:items-center sm:pt-0"><div class="max-w-4xl mx-auto sm:px-6 lg:px-8"><div class="flex justify-center items-center pt-8 sm:justify-start sm:pt-0"><svg width="65" height="65" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M29.7513 14.261C28.0767 11.3817 23.8903 11.3817 22.2157 14.261L3.96535 45.641C2.29077 48.5204 4.38399 52.1195 7.73316 52.1195H21.9804C20.5493 50.8688 20.0193 48.7051 21.1023 46.8487L34.9243 23.1556L29.7513 14.261Z" fill="#80EEC0"></path><path d="M41.3151 21.1443C42.701 18.7885 46.1656 18.7885 47.5515 21.1443L62.6552 46.8188C64.0411 49.1746 62.3088 52.1194 59.537 52.1194H29.3296C26.5579 52.1194 24.8255 49.1746 26.2114 46.8188L41.3151 21.1443Z" fill="#00DC82"></path></svg><div class="ml-4"><h1 text="2xl">A Better Nuxt 3 Starter</h1></div></div><div class="mt-4 bg-white dark:bg-sky-darker overflow-hidden shadow sm:rounded-lg"><div class="grid grid-cols-1 md:grid-cols-2"><div class="p-6"><div class="flex items-center"><svg class="w-6 h-6 text-cloud-dark dark:text-cloud-light" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg><div class="ml-4 text-lg leading-7 font-semibold"><a href="https://v3.nuxtjs.org" target="_blank" rel="noopener" class="hover:underline text-sky-black dark:text-white">${serverRenderer.exports.ssrInterpolate(messages2.documentation)}</a></div></div><div class="ml-10"><div class="mt-2 text-cloud-dark dark:text-cloud-light text-sm">${serverRenderer.exports.ssrInterpolate(messages2.readDocs)}<br><a href="https://v3.nuxtjs.org" class="inline-block mt-2 text-primary hover:underline" target="_blank" rel="noopener">${serverRenderer.exports.ssrInterpolate(messages2.documentation)}</a></div></div></div><div class="p-6 border-t border-gray-200 dark:border-sky-darkest md:border-t-0 md:border-l"><div class="flex items-center"><svg class="w-6 h-6 text-cloud-dark dark:text-cloud-light" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg><div class="ml-4 text-lg leading-7 font-semibold"><a href="https://twitter.com/nuxt_js" target="_blank" rel="noopener" class="hover:underline text-sky-black dark:text-white">Twitter</a></div></div><div class="ml-10"><div class="mt-2 text-cloud-dark dark:text-cloud-light text-sm">${serverRenderer.exports.ssrInterpolate(messages2.followTwitter)}<br><a href="https://twitter.com/nuxt_js" target="_blank" class="inline-block mt-2 text-primary hover:underline" rel="noopener">@nuxt_js</a></div></div></div></div></div><div class="mt-4 text-sm bg-white border-l-8 border-cloud-light dark:bg-sky-darker dark:border-sky overflow-hidden shadow sm:rounded-lg p-6 pl-4"><p>To remove this welcome page, <strong class="font-bold">you have 2 options</strong>:</p><ul class="list-inside list-disc pt-1 pl-2"><li>Create an <code class="text-primary">app.vue</code></li><li>Create a <code class="text-primary">pages/index.vue</code></li></ul></div><div class="mt-4 text-sm bg-white border-l-8 border-cloud-light dark:bg-sky-darker dark:border-sky overflow-hidden shadow sm:rounded-lg p-6 pl-4"><p>Plugins</p><ul class="list-inside list-disc pt-1 pl-2"><li><a class="text-primary hover:underline" href="https://github.com/windicss/nuxt-windicss" target="_blank">nuxt-windicss</a></li><li><a class="text-primary hover:underline" href="https://github.com/antfu/unplugin-icons">unplugin-icons</a></li><li><a class="text-primary hover:underline" href="https://pinia.esm.dev/ssr/nuxt.html">@pinia/nuxt</a></li><li><a class="text-primary hover:underline" href="https://github.com/intlify/nuxt3">@intlify/nuxt3</a></li><li><a class="text-primary hover:underline" href="https://vueuse.org/nuxt/readme.html#vueuse-nuxt">@vueuse/nuxt3</a></li></ul></div><div class="mt-4 text-sm bg-white border-l-8 border-cloud-light dark:bg-sky-darker dark:border-sky overflow-hidden shadow sm:rounded-lg p-6 pl-4"><p>Some usefull examples:</p><ul class="list-inside list-disc pt-1 pl-2"><li> Use <strong>Pinia</strong> manage store <button class="text-primary px-2 py-1 bg-sky-darker dark:bg-sky-dark focus:outline-transparent rounded-sm">Counter ${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(counterStore).n)}</button></li><li> Create a Serverless Functions in <a class="text-primary hover:underline" href="api/hello?name=World" target="_blank">server/api.ts</a><code>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(data))}</code></li></ul></div><div class="mt-4 text-sm bg-white border-l-8 border-cloud-light dark:bg-sky-darker dark:border-sky overflow-hidden shadow sm:rounded-lg p-6 pl-4"><p>Vue i18n examples:</p><ul class="list-inside list-disc pt-1 pl-2"><li>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(t)("hello", { name: "A Better Nuxt 3 Starter" }))}</li><li>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(t)("menu.home"))}</li></ul></div><div class="py-8 flex justify-center items-center space-x-2"><button class="text-primary px-2 py-1 bg-sky-darker dark:bg-sky-dark focus:outline-transparent rounded-sm">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_carbon58language, { class: "h-5 w-5" }, null, _parent));
      _push(`</button><button class="text-primary px-2 py-1 bg-sky-darker dark:bg-sky-dark focus:outline-transparent rounded-sm">`);
      if (vue_cjs_prod.unref(isDark)) {
        _push(serverRenderer.exports.ssrRenderComponent(_component_carbon58sun, { class: "h-5 w-5" }, null, _parent));
      } else {
        _push(serverRenderer.exports.ssrRenderComponent(_component_carbon58moon, { class: "h-5 w-5" }, null, _parent));
      }
      _push(`</button><button class="text-primary px-2 py-1 bg-sky-darker dark:bg-sky-dark focus:outline-transparent rounded-sm">`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_carbon58logo_github, { class: "h-5 w-5" }, null, _parent));
      _push(`</button></div></div></div></div><div class="absolute left-0 bottom-0 flex items-center justify-center w-full mb-4 text-primary"> Powered By `);
      _push(serverRenderer.exports.ssrRenderComponent(_component_simple_icons58nuxtdotjs, { class: "h-4 w-4 mx-2" }, null, _parent));
      _push(` NuxtJS </div><!--]-->`);
    };
  }
});

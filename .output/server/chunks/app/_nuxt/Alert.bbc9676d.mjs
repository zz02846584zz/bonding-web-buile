import { _ as _export_sfc, u as useState, f as fe, o as oe } from '../server.mjs';
            ...
            if (_push3) {
              _push3(ssrRenderComponent(unref(oe), {
                ...
                default: withCtx((_2, _push4, _parent3, _scopeId2) => {
                  if (_push4) {
                    _push4(`<div class="fixed top-0 left-0 w-full h-full z-30" data-v-e4870405${_scopeId2}><div class="absolute top-0 left-0 w-full h-full cursor-pointer backdrop-filter backdrop-blur-sm bg-dark-900/50" data-v-e4870405${_scopeId2}></div><div class="${ssrRenderClass([[{ "text-center": unref($alert).center }], "p-12 min-w-sm absolute overflow-x-hidden overflow-y-auto transform -translate-x-1/2 -translate-y-7/12 rounded-lg max-w-11/12 backdrop-filter backdrop-blur left-1/2 top-1/2 max-h-4/5 bg-light-100/95 dark:bg-gray-800/80 border border-gray-200 dark:border-gray-100/[0.15] shadow"])}" data-v-e4870405${_scopeId2}><img class="mx-auto mb-6 w-26"${ssrRenderAttr("src", unref(imgType))} data-v-e4870405${_scopeId2}>`);
                    if (unref($alert).title) {
                      _push4(`<div class="${ssrRenderClass([{ "pb-4": unref($alert).text }, "text-lg pl-[0.1em] tracking-widest font-bold text-center"])}" data-v-e4870405${_scopeId2}>${ssrInterpolate(unref($alert).title)}</div>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    if (unref($alert).text) {
                      _push4(`<div data-v-e4870405${_scopeId2}>${ssrInterpolate(unref($alert).text)}</div>`);
                    } else {
                      _push4(`<!---->`);
                    }
                    _push4(`</div></div>`);
...
const Alert = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e4870405"]]);

export { Alert as default };
//# sourceMappingURL=Alert.bbc9676d.mjs.map

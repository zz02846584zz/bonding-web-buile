...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="flex items-center justify-between sticky mb-3"><h1 class="text-xl font-bold">\u6211\u7684\u6536\u85CF</h1></div><div class="flex flex-wrap items-center space-x-4 text-sm mb-3"><!--[-->`);
...
//# sourceMappingURL=collections.f01c8c28.mjs.map
